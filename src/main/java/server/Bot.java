...
public class Bot implements Player {
    private Color color;
    private int size;
    private int[][] possibilities; //Values of possible moves
        ...
        for (int i = 0; i < size; i++) {
            for (int j = 0; j < size; j++) {
                ...
                try {
                    ...
                    if (neighborhood.getValue0() == 1){
                        temp += 4;
                    }
                    else if (neighborhood.getValue0() >= 3){
                        temp -= 4;
                    }
     ...
     */
    @Override
    public void goodMove(final Move enemyMove, final Map map) {
